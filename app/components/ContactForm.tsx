...
const ContactForm = () => {
  ...
  return (
    <section
      id="contact-form"
      className="py-16 sm:py-20 md:py-28 bg-gradient-to-r from-[#6FA1D3] to-[#39536D]"
    >
        ...
        <div className="max-w-3xl mx-auto bg-white/95 backdrop-blur-sm p-8 sm:p-10 md:p-14 rounded-2xl shadow-2xl text-center animate-fade-in">
          <div className="mb-8">
            ...
            <p className="text-lg sm:text-xl text-[#6FA1D3] max-w-2xl mx-auto">
              Pomohu vám k dosažení lepší finanční budoucnosti. Vyplňte formulář
              a já se vám ozvu do 24 hodin.
            </p>
          </div>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label
                  htmlFor="name"
                  className="block text-sm font-semibold text-[#39536D] mb-2"
                >
            ...
            <div>
              <label
                ...
                className="block text-sm font-semibold text-[#39536D] mb-2"
              >
                Dejte mi prosím vědět, o jaké služby máte zájem?{" "}
          ...
          <p className="mt-8 text-sm text-[#39536D] text-center">
            ...
            <a
              href="#"
              className="text-[#6FA1D3] hover:text-[#39536D] font-medium underline-offset-2 hover:underline"
            >
